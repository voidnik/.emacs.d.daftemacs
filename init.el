...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (pdf-tools company-lsp lsp-ui helm-gtags imenu-list objc-font-lock flycheck-objc-clang neotree zerodark-theme company flycheck magit vlf base16-theme flx-isearch flx-ido flx projectile dark-souls haskell-mode))))
(custom-set-faces
