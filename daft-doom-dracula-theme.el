;;; daft-doom-dracula-theme.el --- inspired by the popular Dracula theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup daft-doom-dracula-theme nil
  "Options for the `daft-doom-dracula' theme."
  :group 'doom-themes)

(defcustom daft-doom-dracula-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'daft-doom-dracula-theme
  :type 'boolean)

(defcustom daft-doom-dracula-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'daft-doom-dracula-theme
  :type 'boolean)

(defcustom daft-doom-dracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'daft-doom-dracula-theme
  :type 'boolean)

(defcustom daft-doom-dracula-comment-bg daft-doom-dracula-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'daft-doom-dracula-theme
  :type 'boolean)

(defcustom daft-doom-dracula-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme daft-doom-dracula
  "A dark theme based on Dracula theme"
  ;;#282a36 --> #1c1e26 --> #1e1f29
  ;;#1E2092 --> #14151a --> #16171d
  ;; name        default   256       16
  ((bg         '("#1e1f29" "#262626" "black"        ))
   (bg-alt     '("#16171d" "#1c1c1c" "black"        ))
   (base0      '("#16171d" "#1c1c1c" "black"        ))
   (base1      '("#1e1f29" "#1e1e1e" "brightblack"  ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if daft-doom-dracula-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if daft-doom-dracula-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if daft-doom-dracula-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if daft-doom-dracula-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if daft-doom-dracula-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if daft-doom-dracula-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if daft-doom-dracula-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if daft-doom-dracula-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if daft-doom-dracula-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright daft-doom-dracula-brighter-modeline)
   (-modeline-pad
    (when daft-doom-dracula-padded-modeline
      (if (integerp daft-doom-dracula-padded-modeline) daft-doom-dracula-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if daft-doom-dracula-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
...
;;; daft-doom-dracula-theme.el ends here
